      ...
      <div className='dark:bg-white '>
        <div className="font-karla mx-1 ">
          ...
          <div className='max-w-[940px] mx-auto '>
            ...
            <div className='flex flex-wrap justify-center fade-element sm:gap-5 '>
              <CommonCard
          ...
          <div className='mx-auto max-w-[940px]   mt-[100px]  ' >
            <p className='text-center opacity-80 font-bold text-[12px] uppercase tracking-[2px] fade-element'>More Products</p>
            <div></div>
          ...
          <div className='text-center opacity-50 fade-element font-bold text-[12px] uppercase tracking-[2px] mb-[100px] '>
            Behind the mugs, lifestyle stories
          </div>
          <div className='flex gap-5 flex-wrap max-w-[940px]  mx-auto'>
            <CafeDetail
              classname='max-w-[300px] fade-element'
